...
static const int ALIGN_DATA upd7759_step[16][16] =
{
...
static const int ALIGN_DATA upd7759_state[16] = { -1, -1, 0, 0, 1, 2, 2, 3, -1, -1, 0, 0, 1, 2, 2, 3 };

inline static void UpdateAdpcm(int Data)
{
	...
	if (Chip->adpcm_state < 0)
		...
		Chip->adpcm_state = 15;
#else
	Chip->adpcm_state = __builtin_allegrex_min(Chip->adpcm_state, 15);
	Chip->adpcm_state = __builtin_allegrex_max(Chip->adpcm_state,  0);
#endif
}
