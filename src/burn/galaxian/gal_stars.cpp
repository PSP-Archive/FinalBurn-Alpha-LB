...
static int GalStarsBlinkState = 0;
int GalBlinkTimerStartFrame = 0;
static float GalBlinkEveryFrames = (0.693 * (100000 + 2.0 + 10000) * 0.00001) * (16000.0 / 132 / 2);
...
inline static void GalPlotStar(int x, int y, int Colour)
{
