...
inline static void PsikyoSynchroniseZ80(int nExtraCycles)
{
...
inline static void SendSoundCommand(const char nCommand)
{
...
static int DrvInit()
{
	...
	switch (PsikyoHardwareVersion) {
		case PSIKYO_HW_SAMURAIA:
		case PSIKYO_HW_GUNBIRD: {
			BurnYM2610Init(8000000, 120.0, 100.0, PsikyoSampleROM02, &PsikyoSampleROM02Size, PsikyoSampleROM01, &PsikyoSampleROM01Size, &PsikyoFMIRQHandler, PsikyoSynchroniseStream, PsikyoGetTime, 0);
