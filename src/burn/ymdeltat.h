...
typedef struct deltat_adpcm_state {     /* AT: rearranged and tigntened structure */
	...
	float	freqbase;
#if 0
	float	write_time;		/* Y8950: 10 cycles of main clock; YM2608: 20 cycles of main clock */
	float	read_time;		/* Y8950: 8 cycles of main clock;  YM2608: 18 cycles of main clock */
#endif
	UINT32	memory_size;
	int	output_range;
