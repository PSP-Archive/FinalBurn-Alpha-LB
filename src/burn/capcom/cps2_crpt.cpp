...
static const int ALIGN_DATA fn1_groupA[8] = { 10, 4, 6, 7, 2, 13, 15, 14 };
static const int ALIGN_DATA fn1_groupB[8] = {  0, 1, 3, 5, 8,  9, 11, 12 };

static const int ALIGN_DATA fn2_groupA[8] = { 6, 0, 2, 13, 1,  4, 14,  7 };
static const int ALIGN_DATA fn2_groupB[8] = { 3, 5, 9, 10, 8, 15, 12, 11 };
...
static const struct sbox ALIGN_DATA fn1_r1_boxes[4] =
{
	{	// subkey bits  0- 5
		{
...
static const struct sbox ALIGN_DATA fn1_r2_boxes[4] =
{
	{	// subkey bits 24-29
		{
...
static const struct sbox ALIGN_DATA fn1_r3_boxes[4] =
{
	{	// subkey bits 48-53
		{
...
static const struct sbox ALIGN_DATA fn1_r4_boxes[4] =
{
	{	// subkey bits 72-77
		{
...
static const struct sbox ALIGN_DATA fn2_r1_boxes[4] =
{
	{	// subkey bits  0- 5
		{
...
static const struct sbox ALIGN_DATA fn2_r2_boxes[4] =
{
	{	// subkey bits 24-29
		{
...
static const struct sbox ALIGN_DATA fn2_r3_boxes[4] =
{
	{	// subkey bits 48-53
		{
...
static const struct sbox ALIGN_DATA fn2_r4_boxes[4] =
{
	{	// subkey bits 72-77
		{
...
{
	const struct optimised_sbox ALIGN_DATA *sbox1 = &sboxes[0];
	const struct optimised_sbox ALIGN_DATA *sbox2 = &sboxes[1];
	const struct optimised_sbox ALIGN_DATA *sbox3 = &sboxes[2];
	const struct optimised_sbox ALIGN_DATA *sbox4 = &sboxes[3];
...
{
	static const int ALIGN_DATA bits[96] =
	{
		33, 58, 49, 36,  0, 31,
		22, 30,  3, 16,  5, 53,
		10, 41, 23, 19, 27, 39,
...
static void expand_subkey(UINT32* subkey, UINT16 seed)
{
	...
	static const int ALIGN_DATA bits[64] =
	{
...
static void cps2_decrypt(const UINT32 *master_key, unsigned int upper_limit)
{
	...
	memset(CpsCode, 0, length);
	UINT16 *dec = (UINT16*)CpsCode;
	unsigned int i;
#endif

	UINT32 ALIGN_DATA key1[4];
	struct optimised_sbox ALIGN_DATA sboxes1[4*4];
	struct optimised_sbox ALIGN_DATA sboxes2[4*4];
	...
	for (i = 0; i < 0x10000; ++i)
	{
		...
		UINT16 seed;
		UINT32 ALIGN_DATA subkey[2];
		UINT32 ALIGN_DATA key2[4];
...
struct game_keys
{
	...
	const UINT32 ALIGN_DATA keys[2];
	UINT32 upper_limit;
};
...
static const struct ALIGN_DATA game_keys keys_table[] =
{
