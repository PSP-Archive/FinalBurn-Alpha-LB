...
#define CalcColCPS1(a)	CPSPal2RGB16[a]
#define CalcColCPS2(a)	CPSPal2RGB16[a]

static unsigned short ALIGN_DATA CPSPal2RGB16[0x10000];

static void init_CPSPal2RGB16()
{
	int r, g, b, f, a;
	const int F_OFFSET = 0x0F;
	...
	for( a = 0; a < 0x10000; a++ ) {
		...
		CPSPal2RGB16[a] = ((b & 0xf8) << 8) | ((g & 0xfc) << 3) | ((r & 0xf8) >> 3);
	}	
}
