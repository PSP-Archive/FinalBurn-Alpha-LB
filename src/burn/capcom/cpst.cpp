...
CpstOneDoFn ALIGN_DATA CpstOneDoX[3]    = { CpstOne, CpstOneBgHi, Cps2tOne};
CpstOneDoFn ALIGN_DATA CpstOneObjDoX[2] = { CpstOne, CpstOneObjZ};
...
#ifdef BUILD_PSP
  pCtvLine=pBurnDraw + (nCpstY << 10) + (nCpstX << 1);
#else
