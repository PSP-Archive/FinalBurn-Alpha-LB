...
static struct BurnRomInfo hellfire2RomDesc[] = {
...
STD_ROM_PICK(hellfire2);
STD_ROM_FN(hellfire2);

static struct BurnRomInfo hellfire3RomDesc[] = {
...
STD_ROM_PICK(hellfire3);
STD_ROM_FN(hellfire3);
...
//	nCyclesTotal[0] = (int)((long long)10000000 * nBurnCPUSpeedAdjust / (0x0100 * REFRESHRATE));
	nCyclesTotal[0] = (int)((long long)10000000 / REFRESHRATE);
	nCyclesTotal[1] = (int)((long long)28000000 / 8 / REFRESHRATE);
...
struct BurnDriver BurnDrvHellfir1 = {
	...
	NULL, hellfire1RomInfo, hellfire1RomName, hellfireInputInfo, hellfir1DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvHellfir2 = {
	"hellfire2", "hellfire", NULL, "1989",
	"Hellfire (2P Ver., first edition)\0", NULL, "Toaplan (Taito License)", "Toaplan BCU-2 / FCU-2 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TOAPLAN_RAIZING, GBF_HORSHOOT, 0,
	NULL, hellfire2RomInfo, hellfire2RomName, hellfireInputInfo, hellfireDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	320, 240, 4, 3
};

struct BurnDriver BurnDrvHellfir3 = {
	"hellfire3", "hellfire", NULL, "1989",
	"Hellfire (1P Ver., alt)\0", NULL, "Toaplan (Taito License)", "Toaplan BCU-2 / FCU-2 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_TOAPLAN_RAIZING, GBF_HORSHOOT, 0,
	NULL, hellfire3RomInfo, hellfire3RomName, hellfireInputInfo, hellfireDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	320, 240, 4, 3
};
