...
unsigned int ALIGN_DATA nGP9001ROMSize[2];
static unsigned char* GP9001TileAttrib[2];

static unsigned int ALIGN_DATA nMaxTile[2];
static unsigned int ALIGN_DATA nMaxSprite[2];

static int nControllers;
static int nMode;

unsigned int ALIGN_DATA GP9001TileBank[8];

unsigned char* GP9001RAM[2];
unsigned short* GP9001Reg[2];

unsigned char* GP9001Pointer[2];
int ALIGN_DATA GP9001Regnum[2];
