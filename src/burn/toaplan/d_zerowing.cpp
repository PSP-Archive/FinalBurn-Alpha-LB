...
static struct BurnRomInfo zerowing2RomDesc[] = {
...
STD_ROM_PICK(zerowing2);
STD_ROM_FN(zerowing2);
...
struct BurnDriver BurnDrvZerowing2 = {
	"zerowing2", "zerowing", NULL, "1989",
	...
	NULL, zerowing2RomInfo, zerowing2RomName, zerowingInputInfo, zerowing2DIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	320, 240, 4, 3
};
