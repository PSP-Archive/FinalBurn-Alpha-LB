...
static struct BurnRomInfo bgareggahkRomDesc[] = {
...
STD_ROM_PICK(bgareggahk);
STD_ROM_FN(bgareggahk);
...
static struct BurnRomInfo bgaregganvRomDesc[] = {
...
STD_ROM_PICK(bgaregganv);
STD_ROM_FN(bgaregganv);

static struct BurnRomInfo bgareggat2RomDesc[] = {
...
STD_ROM_PICK(bgareggat2);
STD_ROM_FN(bgareggat2);

static struct BurnRomInfo bgareggacnRomDesc[] = {
...
STD_ROM_PICK(bgareggacn);
STD_ROM_FN(bgareggacn);
...
static int battlegInit()
{
	...
	BurnYM2151Init(32000000 / 8, 100.0);
	MSM6295Init(0, 32000000 / 16 / 132, 100.0, 1);
...
struct BurnDriver BurnDrvBgareggat2 = {
	"bgareggat2", "bgaregga", NULL, "1996",
	...
	NULL, bgareggat2RomInfo, bgareggat2RomName, battlegInputInfo, bgareggaDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	240, 320, 3, 4
};

struct BurnDriver BurnDrvBgareggacn = {
	"bgareggacn", "bgaregga", NULL, "1996",
	"Battle Garegga - Type 2 (Denmark / China) (Tue Apr 2 1996)\0", NULL, "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING, GBF_VERSHOOT, 0,
	NULL, bgareggacnRomInfo, bgareggacnRomName, battlegInputInfo, bgaregcnDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	240, 320, 3, 4
};

struct BurnDriver BurnDrvBgaregganv = {
	"bgaregganv", "bgaregga", NULL, "1996",
	"Battle Garegga - New Version (Austria / Hong Kong) (Sat Mar 2 1996)\0", NULL, "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING, GBF_VERSHOOT, 0,
	NULL, bgaregganvRomInfo, bgaregganvRomName, battlegInputInfo, bgareghkDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	240, 320, 3, 4
};

struct BurnDriver BurnDrvBgareggahk = {
	"bgareggahk", "bgaregga", NULL, "1996",
	"Battle Garegga (Austria / Hong Kong) (Sat Feb 3 1996)\0", NULL, "Raizing / 8ing", "Toaplan GP9001 based",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING, GBF_VERSHOOT, 0,
	NULL, bgareggahkRomInfo, bgareggahkRomName, battlegInputInfo, bgareghkDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	240, 320, 3, 4
};
...
struct BurnDriver BurnDrvBgareggatw = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | TOA_ROTATE_GRAPHICS_CCW, 2, HARDWARE_TOAPLAN_RAIZING, GBF_VERSHOOT, 0,
	NULL, bgareggatwRomInfo, bgareggatwRomName, battlegInputInfo, bgareghkDIPInfo,
	battlegInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &ToaRecalcPalette,
	240, 320, 3, 4
};
