...
#define SAFETY (32)
#define YM2612_BUFFER_SIZE ((4096 + SAFETY) * 4 * sizeof(short))
...
INT8 BurnYM2612Init(UINT8 num, int nClockFrequency, FM_IRQHANDLER IRQCallback, int (*StreamCallback)(int), float (*GetTimeCallback)(), UINT8 bAddSignal)
{
	...
	pBuffer = (short *)malloc(YM2612_BUFFER_SIZE * num);
	memset(pBuffer, 0, YM2612_BUFFER_SIZE * num);
