...
static unsigned char ALIGN_DATA asic3_reg, asic3_latch[3], asic3_x, asic3_y, asic3_z, asic3_h1, asic3_h2;
...
static void asic3_compute_hold(void)
{
	...
	static int ALIGN_DATA modes[4] = { 1, 1, 3, 2 };
	int ALIGN_DATA mode = modes[PgmInput[7] & 3];
...
static const unsigned int ALIGN_DATA AETABLE[16]={0x00,0x0a,0x14,  0x01,0x0b,0x15,  0x02,0x0c,0x16};

//Not sure if BATABLE is complete
static const unsigned int ALIGN_DATA BATABLE[0x40]= {
...
static const unsigned int ALIGN_DATA B0TABLE[16]={2,0,1,4,3}; //maps char portraits to tables

unsigned short ASIC28KEY;
unsigned short ALIGN_DATA ASIC28REGS[10];
unsigned short ALIGN_DATA ASICPARAMS[256];
unsigned short ALIGN_DATA ASIC28RCNT=0;
unsigned int ALIGN_DATA E0REGS[16];

static unsigned int photoy2k_seqpos;
static unsigned int ALIGN_DATA photoy2k_trf[3], photoy2k_soff;
