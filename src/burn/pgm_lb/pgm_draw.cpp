...
static inline unsigned char* getBlockTile(unsigned long offset, unsigned long size)
{
	return getBlock(nPGMTileROMOffset+offset,size);
}
static inline unsigned char* getBlockSPRMask(unsigned long offset, unsigned long size)
{
	return getBlock(nPGMSPRMaskROMOffset+offset,size);
}
static inline unsigned char* getBlockSPRCol(unsigned long offset, unsigned long size)
{
