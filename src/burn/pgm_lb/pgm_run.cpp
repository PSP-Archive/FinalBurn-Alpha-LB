...
unsigned char ALIGN_DATA PgmJoy1[8] = {0,0,0,0,0,0,0,0};
unsigned char ALIGN_DATA PgmJoy2[8] = {0,0,0,0,0,0,0,0};
unsigned char ALIGN_DATA PgmJoy3[8] = {0,0,0,0,0,0,0,0};
unsigned char ALIGN_DATA PgmJoy4[8] = {0,0,0,0,0,0,0,0};
unsigned char ALIGN_DATA PgmBtn1[8] = {0,0,0,0,0,0,0,0};
unsigned char ALIGN_DATA PgmBtn2[8] = {0,0,0,0,0,0,0,0};
unsigned char ALIGN_DATA PgmInput[8] = {0,0,0,0,0,0,0,0};
...
//		}else if(sceIoLseek(cacheFile,0,SEEK_END)!=(nPGMTileROMLen+nPGMSPRColROMLen+nPGMSPRMaskROMLen+nPGMSNDROMLen))
		}else if(sceIoLseek(cacheFile,0,SEEK_END)!=(nPGMTileROMLen+nPGMSPRColROMLen+nPGMSPRMaskROMLen+(bGameDrgw2 ? 0 : nPGMSNDROMLen)))
		{
			bPgmCreateCache = true;
	...
	memset(PGMTileROMExp, 0, (nPGMTileROMLen / 5) * 8);
#endif		
