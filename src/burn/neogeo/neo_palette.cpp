...
unsigned char ALIGN_DATA * NeoPalSrc[2];		// Pointer to input palettes
unsigned int* NeoPalette;
int nNeoPaletteBank;				// Selected palette bank

static unsigned int ALIGN_DATA * NeoPaletteData[2] = {NULL, NULL};
static unsigned short ALIGN_DATA * NeoPaletteCopy[2] = {NULL, NULL};
