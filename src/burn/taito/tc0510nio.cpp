...
unsigned char ALIGN_DATA TC0510NIOInputPort0[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TC0510NIOInputPort1[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TC0510NIOInputPort2[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TC0510NIODip[2]        = { 0, 0 };
unsigned char ALIGN_DATA TC0510NIOInput[3]      = { 0, 0, 0 };
static UINT8  ALIGN_DATA TC0510NIORegs[8];
