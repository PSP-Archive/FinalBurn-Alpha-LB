...
static unsigned char ALIGN_DATA OpwolfADPCM_B[0x08];
static unsigned char ALIGN_DATA OpwolfADPCM_C[0x08];
...
inline static float TaitoGetTime()
{
...
static int ALIGN_DATA DariusCharPlaneOffsets[4]     = { 0, 1, 2, 3 };
static int ALIGN_DATA DariusCharXOffsets[8]         = { 0, 4, 8, 12, 16, 20, 24, 28 };
static int ALIGN_DATA DariusCharYOffsets[8]         = { 0, 32, 64, 96, 128, 160, 192, 224 };
static int ALIGN_DATA DariusCharBPlaneOffsets[2]    = { 0, 8 };
static int ALIGN_DATA DariusCharBXOffsets[8]        = { 0, 1, 2, 3, 4, 5, 6, 7 };
static int ALIGN_DATA DariusCharBYOffsets[8]        = { 0, 16, 32, 48, 64, 80, 96, 112 };
static int ALIGN_DATA DariusSpritePlaneOffsets[4]   = { 24, 8, 16, 0 };
static int ALIGN_DATA DariusSpriteXOffsets[16]      = { 0, 1, 2, 3, 4, 5, 6, 7, 256, 257, 258, 259, 260, 261, 262, 263 };
static int ALIGN_DATA DariusSpriteYOffsets[16]      = { 0, 32, 64, 96, 128, 160, 192, 224, 512, 544, 576, 608, 640, 672, 704, 736 };
static int ALIGN_DATA OpwolfbCharPlaneOffsets[4]    = { 0, 1, 2, 3 };
static int ALIGN_DATA OpwolfbCharXOffsets[8]        = { 0, 4, 8, 12, 16, 20, 24, 28 };
static int ALIGN_DATA OpwolfbCharYOffsets[8]        = { 0, 32, 64, 96, 128, 160, 192, 224 };
static int ALIGN_DATA OpwolfbSpritePlaneOffsets[4]  = { 0, 1, 2, 3 };
static int ALIGN_DATA OpwolfbSpriteXOffsets[16]     = { 0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60 };
static int ALIGN_DATA OpwolfbSpriteYOffsets[16]     = { 0, 64, 128, 192, 256, 320, 384, 448, 512, 576, 640, 704, 768, 832, 896, 960 };
static int ALIGN_DATA RainbowCharPlaneOffsets[4]    = { 0, 1, 2, 3 };
static int ALIGN_DATA RainbowCharXOffsets[8]        = { 8, 12, 0, 4, 24, 28, 16, 20 };
static int ALIGN_DATA RainbowCharYOffsets[8]        = { 0, 32, 64, 96, 128, 160, 192, 224 };
static int ALIGN_DATA RainbowSpritePlaneOffsets[4]  = { 0, 1, 2, 3 };
static int ALIGN_DATA RainbowSpriteXOffsets[16]     = { 8, 12, 0, 4, 24, 28, 16, 20, 40, 44, 32, 36, 56, 60, 48, 52 };
static int ALIGN_DATA RainbowSpriteYOffsets[16]     = { 0, 64, 128, 192, 256, 320, 384, 448, 512, 576, 640, 704, 768, 832, 896, 960 };
static int ALIGN_DATA JumpingCharPlaneOffsets[4]    = { 0, 0x20000*8, 0x40000*8, 0x60000*8 };
static int ALIGN_DATA JumpingCharXOffsets[8]        = { 0, 1, 2, 3, 4, 5, 6, 7 };
static int ALIGN_DATA JumpingCharYOffsets[8]        = { 0, 8, 16, 24, 32, 40, 48, 56 };
static int ALIGN_DATA JumpingSpritePlaneOffsets[4]  = { 0x78000*8, 0x50000*8, 0x28000*8, 0 };
static int ALIGN_DATA JumpingSpriteXOffsets[16]     = { 0, 1, 2, 3, 4, 5, 6, 7, 128, 129, 130, 131, 132, 133, 134, 135 };
static int ALIGN_DATA JumpingSpriteYOffsets[16]     = { 0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120 };
static int ALIGN_DATA RastanCharPlaneOffsets[4]     = { 0, 1, 2, 3 };
static int ALIGN_DATA RastanCharXOffsets[8]         = { 0, 4, 0x200000, 0x200004, 8, 12, 0x200008, 0x20000c };
static int ALIGN_DATA RastanCharYOffsets[8]         = { 0, 16, 32, 48, 64, 80, 96, 112 };
static int ALIGN_DATA RastanSpritePlaneOffsets[4]   = { 0, 1, 2, 3 };
static int ALIGN_DATA RastanSpriteXOffsets[16]      = { 0, 4, 0x200000, 0x200004, 8, 12, 0x200008, 0x20000c, 16, 20, 0x200010, 0x200014, 24, 28, 0x200018, 0x20001c };
static int ALIGN_DATA RastanSpriteYOffsets[16]      = { 0, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448, 480 };
...
static int DariusInit()
{
	...
	BurnYM2203Init(2, 4000000, 8.0, 60.0, TaitoYM2203IRQHandler, TaitoSynchroniseStream, TaitoGetTime, 0);
...
static int JumpingInit()
{
	...
	BurnYM2203Init(2, 3579545, 30.0, 30.0, NULL, TaitoSynchroniseStream, TaitoGetTime, 0);
...
static int TaitoMiscFrame()
{
	...
	for (int i = 1; i <= nInterleave; i++) {
		...
		if (i == nInterleave) SekSetIRQLine(TaitoIrqLine, SEK_IRQSTATUS_AUTO);
		SekClose();
		...
		if (TaitoNumZ80s == 2) {
			...
			nTaitoCyclesSegment = ZetRun(nTaitoCyclesSegment);
			nTaitoCyclesDone[nCurrentCPU] += nTaitoCyclesSegment;
			if (i == nInterleave) ZetRaiseIrq(0);
			ZetClose();
		}
