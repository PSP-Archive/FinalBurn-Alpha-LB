...
unsigned char ALIGN_DATA TC0220IOCInputPort0[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TC0220IOCInputPort1[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TC0220IOCInputPort2[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TC0220IOCDip[2]        = { 0, 0 };
unsigned char ALIGN_DATA TC0220IOCInput[3]      = { 0, 0, 0 };

static UINT8 ALIGN_DATA TC0220IOCRegs[8];
