...
unsigned char ALIGN_DATA TaitoInputPort0[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TaitoInputPort1[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TaitoInputPort2[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TaitoInputPort3[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TaitoInputPort4[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TaitoInputPort5[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
unsigned char ALIGN_DATA TaitoDip[2]        = { 0, 0 };
unsigned char ALIGN_DATA TaitoInput[6]      = { 0, 0, 0, 0, 0, 0 };
...
int ALIGN_DATA nTaitoCyclesDone[4], nTaitoCyclesTotal[4];
