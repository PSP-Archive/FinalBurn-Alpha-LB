...
static int ALIGN_DATA SpritePlaneOffsets[4] = { 8, 12, 0, 4 };
static int ALIGN_DATA SpriteXOffsets[16]    = { 3, 2, 1, 0, 19, 18, 17, 16, 259, 258, 257, 256, 275, 274, 273, 272 };
static int ALIGN_DATA SpriteYOffsets[16]    = { 0, 32, 64, 96, 128, 160, 192, 224, 512, 544, 576, 608, 640, 672, 704, 736 };
...
static int Darius2Init()
{
	...
	BurnYM2610Init(16000000 / 2, 25.0, 100.0, TaitoYM2610ARom, (int*)&TaitoYM2610ARomSize, TaitoYM2610BRom, (int*)&TaitoYM2610BRomSize, &Darius2FMIRQHandler, Darius2SynchroniseStream, Darius2GetTime, 0);
