...
static int TaitoF2SpriteType;
static int TaitoF2SpritesFlipScreen;
static int TaitoF2PrepareSprites;
static INT32 SpritesDisabled, SpritesActiveArea, SpritesMasterScrollX, SpritesMasterScrollY;
static int SpriteBlendMode;
static UINT16 ALIGN_DATA SpriteBank[8];
static UINT16 ALIGN_DATA SpriteBankBuffered[8];
static UINT8 ALIGN_DATA TilePriority[5];
static UINT8 ALIGN_DATA SpritePriority[4];

typedef void (*SpriteBufferUpdate)();
static SpriteBufferUpdate SpriteBufferFunction;
static void NoBuffer();
static void PartialBufferDelayed();
static void PartialBufferDelayedQzchikyu();
static void PartialBufferDelayedThundfox();
static void FullBufferDelayed();
...
static struct BurnInputInfo MegabInputList[] =
{
	{"Coin 1"            , BIT_DIGITAL   , TC0220IOCInputPort2 + 2, "p1 coin"   },
...
static struct BurnDIPInfo DeadconjDIPList[]=
{
	// Default Values
	{0x15, 0xff, 0xff, 0xfe, NULL                             },
	{0x16, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnDIPInfo DondokdjDIPList[]=
{
	// Default Values
	{0x13, 0xff, 0xff, 0xff, NULL                             },
	{0x14, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnDIPInfo DondokduDIPList[]=
{
	// Default Values
	{0x13, 0xff, 0xff, 0xff, NULL                             },
	{0x14, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnDIPInfo GunfronjDIPList[]=
{
	// Default Values
	{0x13, 0xff, 0xff, 0xff, NULL                             },
	{0x14, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnDIPInfo MegabDIPList[]=
{
	// Default Values
	{0x13, 0xff, 0xff, 0xfe, NULL                             },
	{0x14, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnDIPInfo MegabjDIPList[]=
{
	// Default Values
	{0x13, 0xff, 0xff, 0xfe, NULL                             },
	{0x14, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnDIPInfo PuliruljDIPList[]=
{
	// Default Values
	{0x15, 0xff, 0xff, 0xff, NULL                             },
	{0x16, 0xff, 0xff, 0xff, NULL                             },
...
static struct BurnRomInfo CamltruaRomDesc[] = {
	{ "c38-11",             0x020000, 0xbe172da0, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c38-14",             0x020000, 0xffa430de, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
STD_ROM_PICK(Camltrua);
STD_ROM_FN(Camltrua);

static struct BurnRomInfo CamltryaRomDesc[] = {
	{ "c38-11",             0x020000, 0xbe172da0, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
STD_ROM_PICK(Camltrya);
STD_ROM_FN(Camltrya);

static struct BurnRomInfo CameltrjRomDesc[] = {
...
static struct BurnRomInfo DeadconjRomDesc[] = {
	{ "d28-06.3",           0x040000, 0x5b4bff51, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo DondokdjRomDesc[] = {
	{ "b95-12.bin",          0x020000, 0xd0fce87a, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b95-11-1.bin",        0x020000, 0xdad40cd3, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b95-10.bin",          0x020000, 0xa46e1f0b, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
STD_ROM_PICK(Dondokdj);
STD_ROM_FN(Dondokdj);

static struct BurnRomInfo DondokduRomDesc[] = {
	{ "b95-12.bin",          0x020000, 0xd0fce87a, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b95-11-1.bin",        0x020000, 0xdad40cd3, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "b95-10.bin",          0x020000, 0xa46e1f0b, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo GunfronjRomDesc[] = {
	{ "c71-09.ic42",        0x020000, 0x10a544a2, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c71-08.ic41",        0x020000, 0xc17dc0a0, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c71-10.ic40",        0x020000, 0xf39c0a06, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo LiquidkRomDesc[] = {
	{ "c49-09.12",          0x20000, 0x6ae09eb9, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-11.14",          0x20000, 0x42d2be6e, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-10.13",          0x20000, 0x50bef2e0, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-12.15",          0x20000, 0xcb16bad5, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	
	{ "c49-08.9",           0x10000, 0x413c310c, BRF_ESS | BRF_PRG | TAITO_Z80ROM1 },
	
	{ "lk_scr.bin",         0x80000, 0xc3364f9b, BRF_GRA | TAITO_CHARS },
	
	{ "lk_obj0.bin",        0x80000, 0x67cc3163, BRF_GRA | TAITO_SPRITESA },
	{ "lk_obj1.bin",        0x80000, 0xd2400710, BRF_GRA | TAITO_SPRITESA },
	
	{ "lk_snd.bin",         0x80000, 0x474d45a4, BRF_SND | TAITO_YM2610A },
};
...
static struct BurnRomInfo LiquidkuRomDesc[] = {
	...
	{ "c49-11.14",          0x20000, 0x42d2be6e, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-10.13",          0x20000, 0x50bef2e0, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-14.15",          0x20000, 0xbc118a43, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo MizubakuRomDesc[] = {
	...
	{ "c49-11.14",          0x20000, 0x42d2be6e, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-10.13",          0x20000, 0x50bef2e0, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c49-13.15",          0x20000, 0x2518dbf9, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo MegabRomDesc[] = {
...
static struct BurnRomInfo MegabjRomDesc[] = {
	{ "c11-07.55",             0x020000, 0x11d228b6, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c11-08.39",             0x020000, 0xa79d4dca, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c11-06.54",             0x020000, 0x7c249894, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c11-09.18",             0x020000, 0xc830aad5, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo MjnquesbRomDesc[] = {
...
static struct BurnRomInfo PuliruljRomDesc[] = {
	{ "c98-12.rom",          0x040000, 0x816d6cde, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static struct BurnRomInfo SsiRomDesc[] = {
	{ "c64_15-1.bin",       0x040000, 0xce9308a6, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
	{ "c64_16-1.bin",       0x040000, 0x470a483a, BRF_ESS | BRF_PRG | TAITO_68KROM1_BYTESWAP },
...
static int MemIndex()
{
	...
	SpriteList                      = (SpriteEntry*)Next; Next += 0x400 * sizeof(SpriteEntry);
...
static int TaitoF2DoReset()
{
	...
	SpriteBlendMode = 0;
	TilePriority[0] = TilePriority[1] = TilePriority[2] = TilePriority[3] = TilePriority[4] = 0;
	SpritePriority[0] = SpritePriority[1] = SpritePriority[2] = SpritePriority[3] = 0;

	return 0;
}

void TaitoF2SpriteBankWrite(unsigned int Offset, UINT16 Data)
{
	int i, j;
	...
	if (Offset < 4) {
		j = (Offset & 1) << 1;
		i = Data << 11;
		SpriteBankBuffered[j + 0] = i;
		SpriteBankBuffered[j + 1] = i + 0x400;
	} else {
		i = Data << 10;
		SpriteBankBuffered[Offset] = i;
	}
}
...
{
	TC0220IOCHalfWordWrite_Map(0x300000)
	TC0100SCNCtrlWordWrite_Map(0x820000)
...
void __fastcall Dinorex68KWriteWord(unsigned int a, unsigned short d)
{
	...
	TC0100SCNCtrlWordWrite_Map(0x920000)
...
void __fastcall Koshien68KWriteWord(unsigned int a, unsigned short d)
{
	...
	switch (a) {
		case 0xa20000: {
			SpriteBankBuffered[0] = 0x0000;
			SpriteBankBuffered[1] = 0x0400;
			SpriteBankBuffered[2] =  ((d & 0x00f) + 1) * 0x800;
			SpriteBankBuffered[4] = (((d & 0x0f0) >> 4) + 1) * 0x800;
			SpriteBankBuffered[6] = (((d & 0xf00) >> 8) + 1) * 0x800;
			SpriteBankBuffered[3] = SpriteBankBuffered[2] + 0x400;
			SpriteBankBuffered[5] = SpriteBankBuffered[4] + 0x400;
			SpriteBankBuffered[7] = SpriteBankBuffered[6] + 0x400;
			return;
		}
...
unsigned char __fastcall Megab68KReadByte(unsigned int a)
{
...
void __fastcall Megab68KWriteByte(unsigned int a, unsigned char d)
{
...
unsigned short __fastcall Megab68KReadWord(unsigned int a)
{
	TC0220IOCHalfWordRead_Map(0x120000)
...
void __fastcall Megab68KWriteWord(unsigned int a, unsigned short d)
{
	TC0220IOCHalfWordWrite_Map(0x120000)
	TC0360PRIHalfWordWrite_Map(0x400000)
	TC0100SCNCtrlWordWrite_Map(0x620000)
...
{
	TC0100SCNCtrlWordWrite_Map(0x420000)
...
{
	TC0100SCNCtrlWordWrite_Map(0x520000)
	TC0510NIOHalfWordWrite_Map(0x700000)
...
{
	TC0510NIOHalfWordWrite_Map(0x200000)
	TC0100SCNCtrlWordWrite_Map(0x720000)
...
static int ALIGN_DATA CharPlaneOffsets[4]          = { 0, 1, 2, 3 };
static int ALIGN_DATA CharXOffsets[8]              = { 8, 12, 0, 4, 24, 28, 16, 20 };
static int ALIGN_DATA CharYOffsets[8]              = { 0, 32, 64, 96, 128, 160, 192, 224 };
static int ALIGN_DATA PivotPlaneOffsets[4]         = { 0, 1, 2, 3 };
static int ALIGN_DATA PivotXOffsets[8]             = { 0, 4, 8, 12, 16, 20, 24, 28 };
static int ALIGN_DATA PivotYOffsets[8]             = { 0, 32, 64, 96, 128, 160, 192, 224 };
static int ALIGN_DATA YuyugogoCharPlaneOffsets[1]  = { 0 };
static int ALIGN_DATA YuyugogoCharXOffsets[8]      = { 0, 1, 2, 3, 4, 5, 6, 7 };
static int ALIGN_DATA YuyugogoCharYOffsets[8]      = { 0, 8, 16, 24, 32, 40, 48, 56 };
static int ALIGN_DATA TC0480SCPCharPlaneOffsets[4] = { 0, 1, 2, 3 };
static int ALIGN_DATA TC0480SCPCharXOffsets[16]    = { 4, 0, 20, 16, 12, 8, 28, 24, 36, 32, 52, 48, 44, 40, 60, 56 };
static int ALIGN_DATA TC0480SCPCharYOffsets[16]    = { 0, 64, 128, 192, 256, 320, 384, 448, 512, 576, 640, 704, 768, 832, 896, 960 };
static int ALIGN_DATA SpritePlaneOffsets[4]        = { 0, 1, 2, 3 };
static int ALIGN_DATA SpriteXOffsets[16]           = { 4, 0, 12, 8, 20, 16, 28, 24, 36, 32, 44, 40, 52, 48, 60, 56 };
static int ALIGN_DATA SpriteYOffsets[16]           = { 0, 64, 128, 192, 256, 320, 384, 448, 512, 576, 640, 704, 768, 832, 896, 960 };
static int ALIGN_DATA FinalbSpritePlaneOffsets[6]  = { 0x800000, 0x800001, 0, 1, 2, 3 };
static int ALIGN_DATA FinalbSpriteXOffsets[16]     = { 12, 8, 4, 0, 28, 24, 20, 16, 44, 40, 36, 32, 60, 56, 52, 48 };
static int ALIGN_DATA FinalbSpriteYOffsets[16]     = { 0, 64, 128, 192, 256, 320, 384, 448, 512, 576, 640, 704, 768, 832, 896, 960 };
...
static float TaitoF2GetTime()
{
	return (float)ZetTotalCycles() / (24000000 / 6);
}
...
static float CamltryaGetTime()
{
	return (float)ZetTotalCycles() / (24000000 / 4);
}
...
static void TaitoF2SoundInit()
{
	...
	BurnYM2610Init(24000000 / 3, 25.0, 100.0, TaitoYM2610ARom, (int*)&TaitoYM2610ARomSize, TaitoYM2610BRom, (int*)&TaitoYM2610BRomSize, &TaitoF2FMIRQHandler, TaitoF2SynchroniseStream, TaitoF2GetTime, 0);
...
static void TaitoF2Init()
{
	...
	SpriteBufferFunction = NoBuffer;
	TaitoDrawFunction = TaitoF2Draw;
	
	for (int i = 0; i < 8; i++) {
		SpriteBankBuffered[i] = 0x400 * i;
		SpriteBank[i] = SpriteBankBuffered[i];
	}
...
static int CameltryInit()
{
	...
	TC0100SCNInit(1, TaitoNumChar, 3, 8, 0, NULL);
	TC0140SYTInit();
	TC0220IOCInit();
	...
	SekMapMemory(TC0100SCNRam[0]          , 0x800000, 0x813fff, SM_RAM);
...
static int CamltryaInit()
{
	...
	BurnYM2203Init(1, 24000000 / 8, 20.0, 60.0, &TaitoF2FMIRQHandler, CamltryaSynchroniseStream, CamltryaGetTime, 0);
...
static int DeadconxInit()
{
	...
	if (!strcmp(BurnDrvGetTextA(DRV_NAME), "deadconj")) {
...
static int DinorexInit()
{
	...
	TC0100SCNInit(1, TaitoNumChar, 3, 8, 0, TaitoPriorityMap);
	TC0140SYTInit();
	TC0360PRIInit();
	TC0510NIOInit();
	...
	SekMapMemory(TC0100SCNRam[0]          , 0x900000, 0x90ffff, SM_RAM);
...
static int DondokodInit()
{
	...
	SekMapMemory(Taito68KRam1             , 0x100000, 0x10ffff, SM_RAM);
	SekMapMemory(TaitoPaletteRam          , 0x200000, 0x201fff, SM_RAM);
	SekMapMemory(TC0100SCNRam[0]          , 0x800000, 0x80ffff, SM_RAM);
	SekMapMemory(TaitoSpriteRam           , 0x900000, 0x90ffff, SM_RAM);
	SekMapMemory(TC0280GRDRam             , 0xa00000, 0xa01fff, SM_RAM);
	...
	TaitoXOffset = 3;
	SpriteBufferFunction = PartialBufferDelayed;
...
static int FinalbInit()
{
	...
	TC0100SCNInit(1, TaitoNumChar, 1, 8, 0, NULL);
	TC0140SYTInit();
	TC0220IOCInit();
	...
	DecodeGfxRom(TaitoNumSpriteA, TaitoSpriteANumPlanes, TaitoSpriteAWidth, TaitoSpriteAHeight, FinalbSpritePlaneOffsets, FinalbSpriteXOffsets, FinalbSpriteYOffsets, TaitoSpriteAModulo, TempRom, TaitoSpritesA);
	free(TempRom);
...
static int FootchmpInit()
{
	...
	TaitoXOffset = 3;
	SpriteBufferFunction = FullBufferDelayed;
	TaitoDrawFunction = FootchmpDraw;
...
static int KoshienInit()
{
	...
	TC0100SCNInit(1, TaitoNumChar, 1, 8, 0, TaitoPriorityMap);
	TC0140SYTInit();
	TC0360PRIInit();
	TC0510NIOInit();
...
static int MegabInit()
{
	...
	SekMapMemory(TC0100SCNRam[0]          , 0x600000, 0x60ffff, SM_RAM);
	SekMapMemory(Taito68KRam1 + 0x10000   , 0x610000, 0x61ffff, SM_RAM);
	SekMapMemory(TaitoSpriteRam           , 0x800000, 0x80ffff, SM_RAM);
	SekSetReadByteHandler(0, Megab68KReadByte);
	SekSetWriteByteHandler(0, Megab68KWriteByte);
	SekSetReadWordHandler(0, Megab68KReadWord);	
	SekSetWriteWordHandler(0, Megab68KWriteWord);
	SekClose();
...
static int MjnquestInit()
{
	...
	DecodeGfxRom(TaitoNumSpriteA, TaitoSpriteANumPlanes, TaitoSpriteAWidth, TaitoSpriteAHeight, TaitoSpriteAPlaneOffsets, TaitoSpriteAXOffsets, TaitoSpriteAYOffsets, TaitoSpriteAModulo, TempRom, TaitoSpritesA);
	free(TempRom);
	
	TC0110PCRInit(1, 0x1000);
	TC0100SCNInit(1, TaitoNumChar, 0, 8, 0, NULL);
	TC0100SCNSetGfxMask(0x7fff);
	TC0140SYTInit();
	...
	SekMapMemory(TC0100SCNRam[0]          , 0x400000, 0x40ffff, SM_RAM);
...
static int NinjakInit()
{
	...
	TC0100SCNInit(1, TaitoNumChar, 0, 8, 0, TaitoPriorityMap);
	TC0140SYTInit();
...
static int Qcrayon2Init()
{
	...
	SekMapMemory(TC0100SCNRam[0]          , 0x500000, 0x50ffff, SM_RAM);
...
static int QzchikyuInit()
{
	...
	SekMapMemory(TC0100SCNRam[0]          , 0x700000, 0x70ffff, SM_RAM);
	...
	SpriteBufferFunction = PartialBufferDelayedQzchikyu;
...
static int SsiInit()
{
	...
	TC0100SCNInit(1, TaitoNumChar, 0, 0, 0, NULL);
	TC0140SYTInit();
	TC0510NIOInit();
	...
	TaitoXOffset = 3;	
	SpriteBufferFunction = PartialBufferDelayedThundfox;
...
inline static unsigned char pal4bit(unsigned char bits)
{
	bits &= 0x0f;
	return (bits << 4) | bits;
}
...
static void TaitoF2HandleSpriteBuffering()
{
...
static void TaitoF2UpdateSpritesActiveArea()
{
	...
	if ((SpritesActiveArea == 0x8000) && (SpriteRamBuffered[(0x8000 + 6) / 2] == 0) && (SpriteRamBuffered[(0x8000 + 10) / 2] == 0)) SpritesActiveArea = 0;

	for (Off = 0; Off < 0x4000; Off += 16) {
		int Offs = Off + SpritesActiveArea;

		if (SpriteRamBuffered[(Offs + 6) / 2] & 0x8000) {
			SpritesDisabled = SpriteRamBuffered[(Offs + 10) / 2] & 0x1000;
			if (Footchmp) {
				SpritesActiveArea = 0x8000 * (SpriteRamBuffered[(Offs + 6) / 2] & 0x0001);
			} else {
				SpritesActiveArea = 0x8000 * (SpriteRamBuffered[(Offs + 10) / 2] & 0x0001);
			}
		}

		if ((SpriteRamBuffered[(Offs + 4) / 2] & 0xf000) == 0xa000) {
			SpritesMasterScrollX = SpriteRamBuffered[(Offs + 4) / 2] & 0xfff;
			if (SpritesMasterScrollX >= 0x800) SpritesMasterScrollX -= 0x1000;

			SpritesMasterScrollY = SpriteRamBuffered[(Offs + 6) / 2] & 0xfff;
			if (SpritesMasterScrollY >= 0x800) SpritesMasterScrollY -= 0x1000;
		}
	}
}
					...
					if (c != 0) {
						if (SpriteBlendMode) {
							...
							if (TaitoIC_TC0100SCNInUse) {
								if (Pri == 1) TilePri = TilePriority[0];
								if (Pri == 2) TilePri = TilePriority[1];
								if (Pri == 4) TilePri = TilePriority[2];
							}
							
							if (((SpriteBlendMode & 0xc0) == 0xc0) && (Priority == (TilePri - 1))) {
								...
								if (((SpriteBlendMode & 0xc0) == 0xc0) && (Priority == (TilePri + 1))) {
									...
									if (((SpriteBlendMode & 0xc0) == 0x80) && (Priority == (TilePri - 1))) {
...
static void TaitoF2MakeSpriteList()
{
	...
	int Disabled = SpritesDisabled;
	int MasterScrollX = SpritesMasterScrollX;
	int MasterScrollY = SpritesMasterScrollY;
	int Area = SpritesActiveArea;
	
	UINT16 *SpriteRamBuffered = (UINT16*)TaitoSpriteRamBuffered;
	UINT16 *SpriteExtension = (UINT16*)TaitoSpriteExtension;
	struct SpriteEntry *SpritePtr = SpriteList;
	
	memset(SpriteList, 0, 0x400 * sizeof(SpriteEntry));
	...
	for (Off = 0; Off < 0x4000; Off += 16) {
		...
		SpritePtr->Priority = SpritePriority[Priority];
		SpritePtr++;
	}
}

static void TaitoF2RenderSpriteList(int SpritePriorityLevel)
{
	for (int i = 0; i < 0x400; i++) {
		if (SpriteList[i].Priority == SpritePriorityLevel) RenderSpriteZoom(SpriteList[i].Code, SpriteList[i].x, SpriteList[i].y, SpriteList[i].Colour, SpriteList[i].xFlip, SpriteList[i].yFlip, SpriteList[i].xZoom, SpriteList[i].yZoom, SpritePriorityLevel, TaitoSpritesA);
	}
}
...
static void TaitoF2Draw()
{
	...
	if (TC0100SCNBottomLayer()) {
		TilePriority[1] = TC0360PRIRegs[5] & 0x0f;
		TilePriority[0] = TC0360PRIRegs[5] >> 4;
	} else {
		TilePriority[0] = TC0360PRIRegs[5] & 0x0f;
		TilePriority[1] = TC0360PRIRegs[5] >> 4;
	}
	TilePriority[2] = TC0360PRIRegs[4] >> 4;
	
	if (TilePriority[1] < TilePriority[0]) TilePriority[1] = TilePriority[0];

	SpritePriority[0] = TC0360PRIRegs[6] & 0x0f;
	SpritePriority[1] = TC0360PRIRegs[6] >> 4;
	SpritePriority[2] = TC0360PRIRegs[7] & 0x0f;
	SpritePriority[3] = TC0360PRIRegs[7] >> 4;
	
	SpriteBlendMode = TC0360PRIRegs[0] & 0xc0;
	...
	if (SpriteBlendMode) {
		for (i = 0; i < 4; i++) {
			if (SpritePriority[i] == TilePriority[0] - 1) {
				TileAltPriority[0] = SpritePriority[i];
				DrawLayer0 = 0;
			}
	
			if (SpritePriority[i] == TilePriority[1] - 1) {
				TileAltPriority[1] = SpritePriority[i];
				DrawLayer1 = 0;
			}
	
			if (SpritePriority[i] == TilePriority[2] - 1) {
				TileAltPriority[2] = SpritePriority[i];
				DrawLayer2 = 0;
			}
		}
	}
	...
	if (TC0100SCNBottomLayer()) {
		for (i = 0; i < 16; i++) {
			if (TileAltPriority[0] == i) { if (!(Disable & 0x02)) TC0100SCNRenderFgLayer(0, TaitoChars); }
			if (TileAltPriority[1] == i) { if (!(Disable & 0x01)) TC0100SCNRenderBgLayer(0, TaitoChars); }
			if (TileAltPriority[2] == i) { if (!(Disable & 0x04)) TC0100SCNRenderCharLayer(); }
			if (SpritePriority[3] == i) TaitoF2RenderSpriteList(SpritePriority[3]);
			if (SpritePriority[2] == i) TaitoF2RenderSpriteList(SpritePriority[2]);
			if (SpritePriority[1] == i) TaitoF2RenderSpriteList(SpritePriority[1]);
			if (SpritePriority[0] == i) TaitoF2RenderSpriteList(SpritePriority[0]);
			if ((TilePriority[0] == i) && DrawLayer0) { if (!(Disable & 0x02)) TC0100SCNRenderFgLayer(0, TaitoChars); }
			if ((TilePriority[1] == i) && DrawLayer1) { if (!(Disable & 0x01)) TC0100SCNRenderBgLayer(0, TaitoChars); }
			if ((TilePriority[2] == i) && DrawLayer2) { if (!(Disable & 0x04)) TC0100SCNRenderCharLayer(); }
		}
	} else {
		for (i = 0; i < 16; i++) {
			if (TileAltPriority[0] == i) { if (!(Disable & 0x01)) TC0100SCNRenderBgLayer(0, TaitoChars); }
			if (TileAltPriority[1] == i) { if (!(Disable & 0x02)) TC0100SCNRenderFgLayer(0, TaitoChars); }
			if (TileAltPriority[2] == i) { if (!(Disable & 0x04)) TC0100SCNRenderCharLayer(); }			
			if (SpritePriority[3] == i) TaitoF2RenderSpriteList(SpritePriority[3]);
			if (SpritePriority[2] == i) TaitoF2RenderSpriteList(SpritePriority[2]);
			if (SpritePriority[1] == i) TaitoF2RenderSpriteList(SpritePriority[1]);
			if (SpritePriority[0] == i) TaitoF2RenderSpriteList(SpritePriority[0]);			
			if ((TilePriority[0] == i) && DrawLayer0) { if (!(Disable & 0x01)) TC0100SCNRenderBgLayer(0, TaitoChars); }
			if ((TilePriority[1] == i) && DrawLayer1) { if (!(Disable & 0x02)) TC0100SCNRenderFgLayer(0, TaitoChars); }
			if ((TilePriority[2] == i) && DrawLayer2) { if (!(Disable & 0x04)) TC0100SCNRenderCharLayer(); }			
		}
	}
...
//	bprintf(PRINT_NORMAL, _T("TCBL %x, Blend %x, Roz %x, RozBase %x, T0 %x, T1 %x, T2 %x, S0 %x, S1 %x, S2 %x, S3 %x\n"), TC0100SCNBottomLayer(), SpriteBlendMode, RozPriority, TaitoRozBaseColour, TilePriority[0], TilePriority[1], TilePriority[2], SpritePriority[0], SpritePriority[1], SpritePriority[2], SpritePriority[3]);
...
static void CameltryDraw()
{
	...
	for (i = 0; i < 16; i++) {
		...
		if (SpritePriority[0] == i) TaitoF2RenderSpriteList(SpritePriority[0]);
		if (RozPriority == i) TC0280GRDRenderLayer();
		if (TilePriority[2] == i) { if (!(Disable & 0x04)) TC0100SCNRenderCharLayer(); }
	}
...
static void FootchmpDraw()
{
	...
	TilePriority[0] = TC0360PRIRegs[4] >> 4;
	TilePriority[1] = TC0360PRIRegs[5] & 0x0f;
	TilePriority[2] = TC0360PRIRegs[5] >> 4;
	TilePriority[3] = TC0360PRIRegs[4] & 0x0f;
	TilePriority[4] = TC0360PRIRegs[7] >> 4;
	...
	for (int i = 0; i < 16; i++) {
		...
		if (SpritePriority[1] == i) TaitoF2RenderSpriteList(SpritePriority[1]);		
		if (SpritePriority[0] == i) TaitoF2RenderSpriteList(SpritePriority[0]);
		if (TilePriority[0] == i) TC0480SCPTilemapRender(Layer[0], 0, TaitoChars);
		if (TilePriority[1] == i) TC0480SCPTilemapRender(Layer[1], 0, TaitoChars);
		if (TilePriority[2] == i) TC0480SCPTilemapRender(Layer[2], 0, TaitoChars);
		if (TilePriority[3] == i) TC0480SCPTilemapRender(Layer[3], 0, TaitoChars);
	}
...
static void MetalbDraw()
{
	...
	TilePriority[Layer[0]] = TC0360PRIRegs[4] & 0x0f;
	TilePriority[Layer[1]] = TC0360PRIRegs[4] >> 4;
	TilePriority[Layer[2]] = TC0360PRIRegs[5] & 0x0f;
	TilePriority[Layer[3]] = TC0360PRIRegs[5] >> 4;
	TilePriority[4] = TC0360PRIRegs[9] & 0x0f;	
	
	if (TilePriority[1] < TilePriority[0]) TilePriority[1] = TilePriority[0];	
	if (TilePriority[2] < TilePriority[1]) TilePriority[2] = TilePriority[1];
	if (TilePriority[3] < TilePriority[2]) TilePriority[3] = TilePriority[2];
...
//	bprintf(PRINT_IMPORTANT, _T("SPR Bl %x, T0 %x, T1 %x, T2 %x, T3 %x, T4 %x, S0 %x, S1 %x, S2 %x, S3 %x\n"), SpriteBlendMode, TilePriority[0], TilePriority[1], TilePriority[2], TilePriority[3], TilePriority[4], SpritePriority[0], SpritePriority[1], SpritePriority[2], SpritePriority[3]);
//	bprintf(PRINT_NORMAL, _T("L0 %x %x, L1 %x %x, L2 %x %x, L3 %x %x\n"), Layer[0], TilePriority[0], Layer[1], TilePriority[1], Layer[2], TilePriority[2], Layer[3], TilePriority[3]);
...
static void PulirulaDraw()
{
	...
	bprintf(PRINT_NORMAL, _T("TCBL %x, Blend %x, Roz %x, RozBase %x, T0 %x, T1 %x, T2 %x, S0 %x, S1 %x, S2 %x, S3 %x\n"), TC0100SCNBottomLayer(), SpriteBlendMode, RozPriority, TC0280GRDBaseColour, TilePriority[0], TilePriority[1], TilePriority[2], SpritePriority[0], SpritePriority[1], SpritePriority[2], SpritePriority[3]);
...
static int TaitoF2Frame()
{
	...
	for (int i = 1; i <= nInterleave; i++) {
		...
		nCurrentCPU = 0;
		SekOpen(0);
		nNext = i * nTaitoCyclesTotal[nCurrentCPU] / nInterleave;
		nTaitoCyclesSegment = nNext - nTaitoCyclesDone[nCurrentCPU];
		if (i == nInterleave) nTaitoCyclesSegment -= 500;
...
struct BurnDriver BurnDrvFootchmp = {
	...
	NULL, FootchmpRomInfo, FootchmpRomName, FootchmpInputInfo, FootchmpDIPInfo,
	FootchmpInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvHthero = {
	"hthero", "footchmp", NULL, "1990",
...
struct BurnDriver BurnDrvGunfront = {
	...
	NULL, GunfrontRomInfo, GunfrontRomName, GunfrontInputInfo, GunfrontDIPInfo,
	GunfrontInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 224, 320, 3, 4
};

struct BurnDriver BurnDrvGunfronj = {
	"gunfronj", "gunfront", NULL, "1990",
	...
	NULL, GunfronjRomInfo, GunfronjRomName, GunfrontInputInfo, GunfronjDIPInfo,
	GunfrontInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 224, 320, 3, 4
};

struct BurnDriver BurnDrvKoshien = {
	"koshien", NULL, NULL, "1990",
...
struct BurnDriver BurnDrvMjnquesb = {
	...
	NULL, MjnquesbRomInfo, MjnquesbRomName, MjnquestInputInfo, MjnquestDIPInfo,
	MjnquestInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvNinjak = {
	"ninjak", NULL, NULL, "1990",
	"The Ninja Kids (World)\0", NULL, "Taito Corporation Japan", "Taito-F2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 4, HARDWARE_TAITO_TAITOF2, GBF_SCRFIGHT, 0,
	NULL, NinjakRomInfo, NinjakRomName, NinjakInputInfo, NinjakDIPInfo,
	NinjakInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvNinjakj = {
	"ninjakj", "ninjak", NULL, "1990",
	"The Ninja Kids (Japan)\0", NULL, "Taito Corporation", "Taito-F2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_TAITO_TAITOF2, GBF_SCRFIGHT, 0,
	NULL, NinjakjRomInfo, NinjakjRomName, NinjakInputInfo, NinjakjDIPInfo,
	NinjakInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvNinjaku = {
	"ninjaku", "ninjak", NULL, "1990",
	"The Ninja Kids (US)\0", NULL, "Taito America Corporation", "Taito-F2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 4, HARDWARE_TAITO_TAITOF2, GBF_SCRFIGHT, 0,
	NULL, NinjakuRomInfo, NinjakuRomName, NinjakInputInfo, NinjakuDIPInfo,
	NinjakInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvPulirula = {
	"pulirula", NULL, NULL, "1991",
	...
	NULL, PulirulaRomInfo, PulirulaRomName, PulirulaInputInfo, PulirulaDIPInfo,
	PulirulaInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvPulirulj = {
	"pulirulj", "pulirula", NULL, "1991",
	...
	NULL, PuliruljRomInfo, PuliruljRomName, PulirulaInputInfo, PuliruljDIPInfo,
	PulirulaInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvQcrayon = {
	"qcrayon", NULL, NULL, "1993",
	...
	NULL, QcrayonRomInfo, QcrayonRomName, QcrayonInputInfo, QcrayonDIPInfo,
	QcrayonInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvQcrayon2 = {
	"qcrayon2", NULL, NULL, "1993",
...
struct BurnDriver BurnDrvQzquest = {
	...
	BDF_GAME_WORKING, 2, HARDWARE_TAITO_TAITOF2, GBF_QUIZ, 0,
	NULL, QzquestRomInfo, QzquestRomName, QzquestInputInfo, QzquestDIPInfo,
	QzquestInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvSolfigtr = {
	"solfigtr", NULL, NULL, "1991",
	"Solitary Fighter (World)\0", NULL, "Taito Corporation Japan", "Taito-F2",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 2, HARDWARE_TAITO_TAITOF2, GBF_VSFIGHT, 0,
	NULL, SolfigtrRomInfo, SolfigtrRomName, SolfigtrInputInfo, SolfigtrDIPInfo,
...
struct BurnDriver BurnDrvMajest12 = {
	...
	NULL, Majest12RomInfo, Majest12RomName, SsiInputInfo, Majest12DIPInfo,
	SsiInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 224, 320, 3, 4
};

struct BurnDriver BurnDrvYesnoj = {
	"yesnoj", NULL, NULL, "1992",
	...
	BDF_GAME_WORKING, 2, HARDWARE_TAITO_TAITOF2, GBF_QUIZ, 0,
	NULL, YesnojRomInfo, YesnojRomName, YesnojInputInfo, YesnojDIPInfo,
	YesnojInit, TaitoF2Exit, TaitoF2Frame, NULL, TaitoF2Scan,
	0, NULL, NULL, NULL, NULL, 320, 224, 4, 3
};

struct BurnDriver BurnDrvYuyugogo = {
	"yuyugogo", NULL, NULL, "1990",
	...
	BDF_GAME_WORKING, 2, HARDWARE_TAITO_TAITOF2, GBF_QUIZ, 0,
	NULL, YuyugogoRomInfo, YuyugogoRomName, YuyugogoInputInfo, YuyugogoDIPInfo,
