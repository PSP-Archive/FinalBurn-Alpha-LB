...
static unsigned char ALIGN_DATA DrvJoy1[8], DrvJoy2[8], DrvJoy3[8], DrvJoy4[8], DrvReset, DrvDips[2];
...
static int ALIGN_DATA question_address, question_rom, remap_address[16];
