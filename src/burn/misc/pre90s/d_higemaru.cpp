...
static unsigned char ALIGN_DATA DrvJoy1[8], DrvJoy2[8], DrvJoy3[8], DrvDips[3], DrvReset;
...
static int MemIndex()
{
	...
	Palette	       = (unsigned int*)Next; Next += 0x00180 * sizeof(unsigned int);
