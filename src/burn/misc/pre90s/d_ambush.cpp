...
static unsigned char ALIGN_DATA DrvJoy1[8], DrvJoy2[8], DrvReset, DrvDips;
static int *Palette;
...
static int DrvInit()
{
	...
	memset(Mem, 0, (0x10000 + 0x10000 + 0x100 + 0x400));
...
#ifdef BUILD_PSP
			PutPix(pBurnDraw + (pos << 1), BurnHighCol(pxl >> 16, pxl >> 8, pxl, 0));
#else
