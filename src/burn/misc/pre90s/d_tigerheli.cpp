...
static unsigned char ALIGN_DATA tigerhInput[4] = {0,0,0,0};
static unsigned char ALIGN_DATA tigerhInpJoy1[8];
static unsigned char ALIGN_DATA tigerhInpMisc[8];
static unsigned char ALIGN_DATA tigerhReset = 0;
...
static int TigerHeliTextInit()
{
	...
	memset(TigerHeliTextAttrib, 0, 0x0400);
...
static int tigerhInit()
{
	...
	if (strcmp(BurnDrvGetTextA(DRV_NAME), "tigerh") == 0 || strcmp(BurnDrvGetTextA(DRV_NAME), "tigerhb1") == 0 || strcmp(BurnDrvGetTextA(DRV_NAME), "tigerhb2") == 0 || strcmp(BurnDrvGetTextA(DRV_NAME), "tigerhb3") == 0) {
		nWhichGame = 0;
	}
