...
static unsigned char ALIGN_DATA DrvDip[3]        = {0, 0, 0};
...
static int DrvInit()
{
	...
	DecodeGfxRom(0x1000, 4, 16, 16, SpritePlaneOffsets, SpriteXOffsets, SpriteYOffsets, 0x100, DrvTempRom, DrvSprites);
	...
	BurnYM2203Init(2, 3579545, 40.0, 40.0, &DrvYM2203IRQHandler, DrvSynchroniseStream, DrvGetTime, 0);
	BurnTimerAttachZet(3579545);
	
	MSM6295Init(0, 7575, 98.0, 1);
...
static int LastduelInit()
{
	...
	DecodeGfxRom(0x1000, 4, 16, 16, LdFgTilePlaneOffsets, LdTileXOffsets, LdTileYOffsets, 0x200, DrvTempRom, DrvFgTiles);
