...
static unsigned char ALIGN_DATA DrvJoy1[8], DrvJoy2[8], DrvJoy3[8], DrvReset, DrvDips;
static int *Palette;
...
static int DrvInit()
{
	...
	memset(Mem, 0, (0x10000 + 0x10000 + 0x20000 + 0x300 + 0x800));
...
inline static void bankp_plot_pixel(int x, int y, int color, unsigned char src, int transp)
{
