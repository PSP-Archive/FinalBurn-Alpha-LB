...
static unsigned char ALIGN_DATA gunsmoke_scrollx[2], gunsmoke_scrolly;
...
inline static void gunsmoke_bankswitch(int nBank)
{
...
static int DrvInit()
{
	...
	BurnYM2203Init(2, 1500000, 22.0, 14.0, NULL, gunsmokeSynchroniseStream, gunsmokeGetTime, 0);
