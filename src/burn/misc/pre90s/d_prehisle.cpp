...
static unsigned char ALIGN_DATA PrehisleInputPort0[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA PrehisleInputPort1[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA PrehisleInputPort2[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA PrehisleDip[2]        = {0, 0};
static unsigned char ALIGN_DATA PrehisleInput[3]      = {0x00, 0x00, 0x00};
...
static unsigned short ALIGN_DATA VidControl[7];
...
int PrehisleInit()
{
	...
	DecodeGfxRom(5120, 4, 16, 16, TilePlaneOffsets, TileXOffsets, TileYOffsets, 0x400, PrehisleTempGfx, PrehisleSprites);
