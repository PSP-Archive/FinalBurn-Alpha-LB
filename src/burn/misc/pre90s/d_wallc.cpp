...
static int ALIGN_DATA Palette[8];

static unsigned char ALIGN_DATA DrvJoy1[8], DrvDips[2], DrvReset;
static unsigned short ALIGN_DATA DrvAxis[1];
...
static int DrvInit()
{
	...
	memset(Mem, 0, (0x10000 + 0x04000 + 0x00020));
