...
static unsigned char ALIGN_DATA SolomonInputPort0[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA SolomonInputPort1[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA SolomonInputPort2[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA SolomonDip[2]        = {0, 0};
static unsigned char ALIGN_DATA SolomonInput[3]      = {0x00, 0x00, 0x00};
