...
static unsigned char ALIGN_DATA pf1_control[8],pf2_control[8],pf3_control[8],pf4_control[8];
...
static unsigned char ALIGN_DATA sound_status[2];
static unsigned char ALIGN_DATA sound_latch[2];
...
unsigned char __fastcall m92SndReadByte(unsigned int vezAddress)
{
	...
	switch (vezAddress) {
		...
		case 0xa8042:
		case 0xa8043:
			return BurnYM2151ReadStatus(vezAddress & 0x01);
		//case 0xa8043:
...
static int hookInit()
{
	...
	BurnYM2151Init(3579545, 40.0);		// 3.5795 MHz
