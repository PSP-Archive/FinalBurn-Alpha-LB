...
static unsigned char ALIGN_DATA DrvButton[7] = {0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA DrvJoy1[7] = {0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA DrvJoy2[7] = {0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA DrvInput[6] = {0, 0, 0, 0, 0, 0};
static unsigned char DrvReset = 0;
//static unsigned short GalPanicCoin = 0;

unsigned char RecalcBgPalette;

static int ALIGN_DATA nCyclesDone[1], nCyclesTotal[1];
...
//	nCyclesTotal[0] = (int)((long long)8000000 * nBurnCPUSpeedAdjust / (0x0100 * 60));
	nCyclesTotal[0] = (int)((long long)8000000 / 60);
