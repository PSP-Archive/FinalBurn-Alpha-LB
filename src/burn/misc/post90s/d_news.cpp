...
static unsigned char ALIGN_DATA NewsInputPort0[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA NewsDip[1]        = {0};
static unsigned char ALIGN_DATA NewsInput[1]      = {0x00};
...
int NewsInit()
{
	...
	DecodeGfxRom(16384, 4, 8, 8, TilePlaneOffsets, TileXOffsets, TileYOffsets, 0x100, NewsTempGfx, NewsTiles);
	free(NewsTempGfx);
