...
static unsigned char ALIGN_DATA DrvJoy1[16], DrvJoy2[16], DrvDips[2], DrvReset;
static unsigned short ALIGN_DATA DrvInputs[2];
...
static int DrvGfxDecode()
{
	...
	for (int i = 0; i < 4; i++ ){
		...
		DecodeGfxRom(0x08000, 6, 16, 16, Planes, XOffs, YOffs, 0x200, tmp, DrvGfx + 0x0800000 * i);
	}
...
//	int nTotalCycles = (int)((long long)16000000 * nBurnCPUSpeedAdjust / (0x0100 * 60));
	int nTotalCycles = (int)((long long)16000000 / 60);
