...
static unsigned char ALIGN_DATA DrvInputPort4[8] = {0, 0, 0, 0, 0, 0, 0, 0};
static unsigned char ALIGN_DATA DrvDip[2]        = {0, 0};
static unsigned char ALIGN_DATA DrvInput[5]      = {0, 0, 0, 0, 0};
...
static int ALIGN_DATA DrvBg1XOffset[2];
...
static int DrvInit()
{
	...
	DecodeGfxRom(0x1000, 4, 16, 16, TilePlaneOffsets, TileXOffsets, TileYOffsets, 0x200, DrvTempRom, DrvTiles);
	...
	DecodeGfxRom(0x10000, 4, 16, 16, SpritePlaneOffsets, SpriteXOffsets, SpriteYOffsets, 0x100, DrvTempRom, DrvSprites);
