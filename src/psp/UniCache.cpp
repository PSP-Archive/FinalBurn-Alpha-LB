...
UniCacheIndex ALIGN_DATA uniCacheIndex[CACHE_INDEX_SIZE];
...
unsigned int ALIGN_DATA uniCacheSpaceStatus[CACHE_SPACE_STATUS_SIZE] = { 0xffffffff, };
...
void initUniCache(unsigned int cacheSize)
{
